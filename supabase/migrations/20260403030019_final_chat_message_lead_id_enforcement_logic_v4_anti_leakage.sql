-- 20260403030019_final_chat_message_lead_id_enforcement_logic_v4_anti_leakage
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- 1. Amarra as órfãs existentes pelo telefone (Caso tenha sobrado alguma)
UPDATE public.chat_messages m
SET lead_id = l.id
FROM public.leads l
WHERE m.lead_id IS NULL 
  AND m.phone = l.phone 
  AND m.clinic_id = l.clinic_id;

-- 2. Atualiza a trigger para ser 100% rígida com o lead_id
