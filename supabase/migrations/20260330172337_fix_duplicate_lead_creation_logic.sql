-- 20260330172337_fix_duplicate_lead_creation_logic
...
BEGIN
    ...
    -- [C] CAPTURA/CRIAÇÃO DE LEAD (COM PROTEÇÃO CONTRA DUPLICIDADE PELA RACE CONDITION)
