-- Painel Administrativo: "Estouros de SLA" passa a contar EVENTOS (sla_breaches) por DATA DO
-- ESTOURO (breached_at) no período, com teto de 1h só p/ IA — fonte única, alinhada ao Comercial.
-- Antes: SUM(leads.sla_breach_count) por data de ENTRADA do lead (acumulado vitalício).
