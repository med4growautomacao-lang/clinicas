-- 20260714024939_fix_contador_de_condicao
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- O contador de uma CONDIÇÃO não pode subir a cada verificação.
--
-- O monitor roda de 5 em 5 min. Como o `occurrences` incrementava em toda reincidência, um WhatsApp
-- caído acumularia 288 "ocorrências" por dia — número que não significa nada e que ainda por cima
-- ordena a lista errado, jogando a condição mais VELHA para o topo em vez da mais grave.
--
