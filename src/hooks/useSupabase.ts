...
export function useTickets() {
  ...
  // Encerramento (mensagem finish ao lead: ganho/perdido/serviço) migrou para o banco:
  // o trigger nativo `trg_ticket_finish_message` envia e registra ao finalizar o ticket
  ...
  const finalizeTicket = async (ticketId: string) => {
    ...
    // Encerramento de serviço (ticket_closed) é enviado nativamente pelo trigger
...
export interface AIConfig {
  ...
  pos_followup_window_start?: number;
  pos_followup_window_end?: number;
