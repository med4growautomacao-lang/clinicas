-- 20260625221749_reengagement_outbound_trigger
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Reengajamento dispara quando a ÚLTIMA mensagem da conversa foi NOSSA (outbound) e o lead não
-- respondeu há mais que o delay — i.e., "mandamos algo e ele ghostou". Substitui o gate anterior
-- (por último inbound), que reengajava até quando a bola estava com a gente (última msg era dele)
-- ou logo após a gente mandar uma mensagem a um lead antigo.
