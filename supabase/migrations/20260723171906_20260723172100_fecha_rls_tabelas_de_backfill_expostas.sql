-- 20260723171906_20260723172100_fecha_rls_tabelas_de_backfill_expostas
...
-- `service_role` tem BYPASSRLS e as funcoes SECURITY DEFINER rodam como dono da tabela, entao
-- run_system_monitors, os crons e as edges seguem lendo/escrevendo normalmente. Nenhum arquivo em
-- src/ referencia qualquer uma destas 30 tabelas (verificado por busca antes de aplicar).
--
