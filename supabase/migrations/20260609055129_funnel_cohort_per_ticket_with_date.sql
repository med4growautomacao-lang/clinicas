-- 20260609055129_funnel_cohort_per_ticket_with_date
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Adiciona entry_date (data da última entrada na etapa, por ticket) ao retorno do RPC,
-- para o front conseguir bucketizar por período (gráfico/tabela) e somar (cards/funil)
-- a partir de UMA fonte só. Mantém a regra por ticket / última entrada.
