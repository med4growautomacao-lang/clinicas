-- 20260724070039_20260724200000_onboarding_audit_reset_on_reaudit
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Permite "voltar / re-auditar" um card sem duplicar: antes de aplicar a categoria, desfaz a
-- decisão anterior (remove tickets secundários de onboarding do lead e devolve o ticket principal
-- limpo à Sincronização). No 1º audit é praticamente no-op.
...
BEGIN
  ...
  -- RESET (idempotência / voltar): apaga tickets secundários de onboarding e devolve o principal limpo.
