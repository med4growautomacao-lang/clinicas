...
import { Send, Loader2, RotateCcw, FlaskConical, Bot } from 'lucide-react';
...
// Sempre escopado à clínica ativa (prop). O AISecretary só monta quando clinic?.id existe.
export function SandboxPanel({ clinicId }: { clinicId: string }) {
        ...
        <div className="border-t border-slate-200 p-3 bg-white rounded-b-2xl">
          <div className="flex items-end gap-2">
            <textarea
              ...
              disabled={sending}
              rows={1}
              placeholder="Escreva como se fosse o paciente…"
