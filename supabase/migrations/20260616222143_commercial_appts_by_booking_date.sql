-- 20260616222143_commercial_appts_by_booking_date
...
BEGIN
  ...
  -- AGENDAMENTOS por DATA DA MARCAÇÃO (created_at)
  SELECT
  ...
  -- consultas realizadas (denominador ticket médio): por DATA DA MARCAÇÃO
