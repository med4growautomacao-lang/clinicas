-- 20260720004819_ticket_finish_message_native
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Encerramento nativo (C6): ao finalizar o ticket, envia a mensagem de encerramento ao lead
-- e registra na conversa — substitui o n8n "Encerramento" (webhook-proxy). Espelha o front:
...
declare
  ...
  v_token text;
begin
  -- Detecta o evento de encerramento (prioriza outcome; serviço = status->closed sem mexer no outcome).
