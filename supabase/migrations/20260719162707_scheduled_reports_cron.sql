-- 20260719162707_scheduled_reports_cron
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Fase D: relatórios agendados. Cron horário varre report_settings habilitados;
-- quando a hora/dia (SP) batem e ainda não houve envio agendado hoje, envia pelo
-- WhatsApp da org (send_clinic_report). Janela = últimos period_days dias completos
-- (ontem para trás). Falha de uma clínica não derruba as demais (log na Central).
