-- 20260724173502_20260724300000_onboarding_import_window_90d
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Janela do onboarding de 30 -> 90 dias. Isto só ALARGA o filtro do import; para o store da uazapi
-- realmente ter 90 dias é preciso o deep-sync (POST /message/history-sync) reabastecer antes.
