-- Painel Comercial — série DIÁRIA: acrescenta INVESTIMENTO por dia (marketing_data, escopo origem)
-- ao daily, para o gráfico de Tendências calcular as taxas (Custo/Agend., CAC, ROAS) e conversões
-- por bucket. Mantém realizadas/ganhos/faturamento/faturamentoProjetado da 20260618000002.
