...
-- no bloco finance, para o card "Ticket Médio (Agendamentos)": projeta a receita potencial dos
-- agendamentos JÁ CRIADOS no período (appointments.total × ticket configurado em Dados da Clínica).
