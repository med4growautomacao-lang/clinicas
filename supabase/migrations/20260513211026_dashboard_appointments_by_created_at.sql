-- 20260513211026_dashboard_appointments_by_created_at
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Conta agendamentos pelo created_at (dia da marcação) em vez de date (dia da consulta)
...
BEGIN
  ...
  -- AGENDAMENTOS: dia da MARCACAO (created_at), nao dia da consulta
  ...
  -- AGENDAMENTOS no chart tambem por created_at
