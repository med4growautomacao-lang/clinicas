-- 20260727205713_crm_lead_intake_fixes
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Correções do review do tipo=lead do CRM (27/07). Decisão do dono: o lead do CRM entra na
-- etapa WHATSAPP (não em forms). Ver 20260727175211_crm_lead_intake_fixes.sql no repo.
...
BEGIN
  ...
  IF p_outcome = 'lead' THEN
    ...
    IF v_ticket_id IS NULL THEN
      ...
      -- ticket) contava a mesma pessoa duas vezes.
