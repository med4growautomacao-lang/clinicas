-- 20260502155755_update_create_clinic_rpc_category_v2
...
CREATE OR REPLACE FUNCTION public.create_clinic_with_owner(
  ...
  p_category text DEFAULT 'clinica'
)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN 
  ...
  INSERT INTO public.clinics (name, plan, organization_id, category) 
  VALUES (p_clinic_name, p_plan, p_organization_id, p_category) RETURNING id INTO v_clinic_id; 
