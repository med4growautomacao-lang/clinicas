-- 20260527223706_add_consultation_type_working_hours_override
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- 1) Coluna nullable, NULL = herda do médico
ALTER TABLE public.consultation_types
  ADD COLUMN IF NOT EXISTS working_hours_override jsonb NULL;

-- 2) Reescrever get_available_slots aplicando override quando presente
