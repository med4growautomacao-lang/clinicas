-- 20260729033421_conv_ai_mine_candidates_bigrams_back
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Devolve os 2-gramas (sinais curtos como "vou encerrar" / "confirmar consulta" / "cancelar
-- consulta" são de 2 palavras). Mantém cap de 50 palavras e a folga de timeout.
