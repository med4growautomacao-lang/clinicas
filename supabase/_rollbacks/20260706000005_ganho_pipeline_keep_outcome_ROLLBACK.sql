-- Rollback de 20260706000005_ganho_pipeline_keep_outcome.sql
DROP FUNCTION IF EXISTS public.move_ticket_keep_outcome(uuid, uuid);

-- Restaura fn_enforce SEM o ramo do sinalizador app.keep_ticket_outcome
