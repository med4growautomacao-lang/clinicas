-- 20260612210354_book_appointment_guard_invalid_phone
...
BEGIN
  ...
  -- Guarda de telefone: ausente/invalido nunca deve criar agendamento orfao.
  -- Numero BR canonico normalizado = 12 digitos (55 + DDD + 8).
