-- 20260617040208_sla_breach_trigger_logs_event
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Aumenta o trigger de SLA: além de incrementar leads.sla_breach_count (mantido p/ o badge),
-- grava um EVENTO em sla_breaches no momento do estouro, com sender/overshoot/wait_raw.
