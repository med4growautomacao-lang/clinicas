...
import { Building2, Users, ArrowRight, LogIn, Loader2, X, Eye, EyeOff, Search } from "lucide-react";
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
              {clinics.filter(c => c.name.toLowerCase().includes(clinicSearch.toLowerCase())).map((clinic) => (
                <motion.div
                  ...
                  whileHover={{ y: -1 }}
                  className={cn(
                    "p-3 rounded-xl border shadow-sm cursor-pointer transition-all",
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1 px-2 py-1.5 rounded-lg text-[10px] font-bold bg-teal-50 text-teal-700 hover:bg-teal-100 border border-teal-100 transition-all"
                  >
                    + Usuário
                  </button>
                  ...
                  <button
                    ...
                    className={cn(
                      "mt-1.5 w-full flex items-center justify-center gap-1.5 px-2 py-1.5 rounded-lg text-[10px] font-bold transition-all",
                      activeClinicId === clinic.id
