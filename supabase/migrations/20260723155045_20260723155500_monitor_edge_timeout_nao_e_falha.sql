-- 20260723155045_20260723155500_monitor_edge_timeout_nao_e_falha
...
--
-- O estrago era de observabilidade: 100 alarmes falsos de conv-ai-analyst_falhou e 67 de
-- meta-forms-sync_falhou, para funcoes saudaveis. A Central e o unico olho que temos; alerta
-- falso soterra o alerta de verdade, entao ruido aqui e pior do que nao monitorar.
--
...
-- loga, e o monitor cron_parado_* pega o caso de a funcao nem ser chamada.
--
