-- 20260723202427_20260723190000_emissor_media_filename
...
-- emit_message. Append no FIM da assinatura de proposito: as chamadas nomeadas (6 produtores) e
-- as posicionais (testes pgTAP, 16 args) seguem validas sem tocar em nada.
