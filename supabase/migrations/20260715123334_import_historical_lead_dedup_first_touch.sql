-- 20260715123334_import_historical_lead_dedup_first_touch
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Fix: o 1º toque de um lead RECÉM-CRIADO já ganha touchpoint automático do trigger
-- fn_touchpoint_from_site_form (external_ref = lead_id::text). Meu loop inserindo TODOS os
-- toques duplicava esse primeiro. Agora o toque de índice 0 usa o MESMO external_ref do
-- trigger -> o ON CONFLICT deduplica sozinho (e ainda cobre o caso de lead JÁ existente,
-- onde o trigger não disparou e esse insert deve valer).
