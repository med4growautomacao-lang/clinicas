-- Monitor novo: lead de formulario marcado como "boas-vindas enviada" que nunca virou conversa.
-- E o buraco exato onde 6 leads da Clinica Vaz sumiram entre 24 e 27/07 sem barulho nenhum:
-- o claim marca welcome_sent=true ANTES do envio, o envio falhou, chat_messages ficou vazio e o
-- reengajamento (que so olha lead com conversa) nunca os viu. O card fica aberto no Kanban com
-- cara de saudavel: whatsapp_invalid=false, sem erro visivel na tela.
