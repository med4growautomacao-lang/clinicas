-- 20260724183439_20260724370000_onboarding_import_no_avatar_resurrect
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- #5: o import NÃO re-seta avatar de lead EXISTENTE (só define no INSERT do lead novo). Antes o
-- `avatar_url = coalesce(avatar_url, foto)` ressuscitava a URL pps depois do re-host ter zerado a
-- morta, causando churn (null <-> pps) enquanto o deep-sync/harvest roda. A persistência de foto
-- fica com a edge onboarding-rehost-avatars + o wa-inbound ao vivo.
