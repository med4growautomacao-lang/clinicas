-- 20260528000727_book_appointment_uses_consultation_type_slug
...
BEGIN
  ...
  -- Resolve consultation_type pelo slug (parametro p_modality carrega o slug)
  ...
  v_final_modality := v_ct.modality;  -- presencial OU online (derivado do tipo)
