-- 20260721213117_conv_ai_context_with_rules
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- conv_ai_get_context passa a entregar duas coisas novas:
--
-- 1) REGRAS DE GATILHO da clínica (par palavra-chave -> etapa). É conhecimento
--    que o cliente já escreveu e a IA ignorava: "nesta clínica, esta frase
--    significa esta etapa". Só o par vai no prompt; os campos context e
--    lead_response ficam de fora (estão vazios em quase todas as regras e o
--    lugar do conhecimento de negócio é o manual versionado).
--
-- 2) ÚLTIMO MOVIMENTO POR GATILHO, com a idade. O motor de palavra-chave e a IA
--    são dois donos possíveis do mesmo card: o gatilho move na hora da mensagem,
--    a IA reavalia minutos depois. Sem isso, a IA desfaz em silêncio o que a
--    regra do cliente acabou de fazer.
...
BEGIN
  ...
  -- Último movimento feito pelo motor de palavra-chave neste ticket.
