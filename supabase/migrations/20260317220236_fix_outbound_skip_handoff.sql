-- 20260317220236_fix_outbound_skip_handoff
...
BEGIN
    ...
    IF NEW.lead_id IS NOT NULL THEN
        ...
        ELSIF NEW.direction = 'outbound' THEN
            ...
            -- Se é handoff, NÃO atualiza last_outbound_at (lead ainda precisa de resposta humana)
            IF v_is_handoff THEN
                UPDATE public.leads SET ai_enabled = false, updated_at = now() WHERE id = NEW.lead_id;
            ELSE
                -- Verifica se estourou SLA antes de responder
