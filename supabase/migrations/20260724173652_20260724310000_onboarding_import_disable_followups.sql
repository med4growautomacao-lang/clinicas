-- 20260724173652_20260724310000_onboarding_import_disable_followups
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Ao INICIAR o onboarding (import), desliga os follow-ups também (não só no reset).
-- Assim "começar a organização" garante follow-ups off; o aviso na tela é fiel.
