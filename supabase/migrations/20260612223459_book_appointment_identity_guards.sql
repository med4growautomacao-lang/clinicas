-- 20260612223459_book_appointment_identity_guards
-- Exportado de supabase_migrations.schema_migrations em 11/08/2026 (backfill).
-- JA APLICADA em producao nesta versao. Arquivo existe para o repo poder reconstruir o banco.

-- Guardas de identidade explicita: lead_id/patient_id invalidos retornam erro limpo
-- (antes criariam orfao ou estourariam FK). Resto da book_appointment inalterado.
